...
data "template_file" "ansible_inventory" {
  ...
  vars = {
    ...
    grafana_public_ip     = yandex_compute_instance.grafana.network_interface.0.nat_ip_address  # ← Добавили!
    ...
    kibana_public_ip         = yandex_compute_instance.kibana.network_interface.0.nat_ip_address  # ← Добавили!
...
resource "local_file" "ansible_inventory" {
  ...
  # Не перезаписывать при изменениях
  lifecycle {
