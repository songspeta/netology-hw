# Домашнее задание к занятию «Применение принципов IaaC в работе с виртуальными машинами» - Спетницкий Д.И.
...
Ну когда-нибудь я это и сделаю, но смысл давать такое задание на середине курса, когда еще пол года назад приходилось разбираться с Вагрантом и Яндексом, нет бы углубиться в Докер или еще что-то